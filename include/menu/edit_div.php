...
$var_path = $root_dir.'/include/edit_element/div';
?>
<div class="w_panel__cont">
  <div class="w_panel__head">
    ...
    <div class="w_menu" id="p_text">Текст</div>
  ...
  <div class="w_panel_cont" id="c_text" style="display: none;">
    <?php
    include($var_path.'/text.php'); /*Текст*/
    ?>
  </div>
  ...
  <div class="w_panel_cont" id="c_events" style="display: none;">
    <?php
    include($var_path.'/events.php'); /*Анимации*/
    ?>
  </div>
</div>
